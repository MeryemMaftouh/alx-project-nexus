...
An intensive hands-on program focused on mastering **modern web and mobile development**, UI/UX design, and frontend architecture using industry-standard tools and technologies.
...
- **Design:** Figma, Semantic HTML  
- **CSS:** Grid, Flexbox, Preprocessors (Sass)  
- **JavaScript & TypeScript**  
- **React.js:** Hooks, Architecture, Components  
...
- Use **Git effectively** with clear commits  
